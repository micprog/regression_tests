...
/////////////////////////////////////////////////////////
  ...
  RT_LOCAL_DATA static const float fv0[16] = { 4.24753476F, 4.24724483F, 0.495684743F,
  ...
  RT_LOCAL_DATA static const float fv1[4] = { 0.13089969749999999515F,    // 2pi/48kHz*1000Hz
                                                                       0.20629792325999998792F,    // 2pi/48kHz*1576Hz
                                                                       0.33327062983499999849F,    // 2pi/48kHz*2546Hz
                                                                       0.49440815745749999710F };  // 2pi/48kHz*3777Hz
  
  RT_LOCAL_DATA static const float fv2[4] = { 1.0F,    // 1.0
                                                                       1.0F,    // 1.0
                                                                       1.0F,    // 1.0
                                                                       1.0F };  // 1.0
